...
export const templateTemplo = ()=> {
    ...
    telaApp.innerHTML = "";
    $("#app").fadeIn(300);
    telaApp.style = `background: url("img/templo-interno.jpg") no-repeat center; background-size: cover;`;
    const mercadoTopo = `
    <div class="headerPerfil"><div class="imgPerfil"><img src="avatar"></div><div class="user">dfd</div></div>
    `;
    telaApp.innerHTML =`<div class="headerPerfil"><div class="imgPerfil"><img src=${avatar}></div><div class="user">${usuario}</div><div class="back-button" data-back="inicio"></div></div><div class="img-rabino"></div>`;
    let estiloHeader = document.querySelector(".headerPerfil");
    estiloHeader.style = styleHeader;
     //criando botão de voltar
     const backButton = document.querySelector(".back-button");
     masterAudioControl("frase-padrao-templo.mp3").play();
